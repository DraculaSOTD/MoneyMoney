...
from database import TradingProfile, ProfileMetrics, ProfileType, Base

# Database configuration
# DATABASE_URL = "postgresql://postgres:password@localhost/trading_db"
DATABASE_URL = "sqlite:///trading.db"  # Using SQLite for now
